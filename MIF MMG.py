...
def modelo(direccion, nlong, nz, long, esp, alt, ti, parametros_mamposteria,
    ...
    # BASE DE COLUMNAS => OJO, ACTUALIZAR CON ALGÚN MODELO ESPECÍFICO
...
#%% inicializar el gráfico 3D para que se dibujen las paredes
fig = plt.figure()
ax = fig.add_subplot(projection='3d')

nudo1, nudo_i1, base_nodes1, elem1, vig1, col11, col21 = modelo(direccion, nlong, nz, long, esp, alt, ti, parametros_mamposteria,
                                                         parametros_portico, secciones, 0, 0, 0, xov, zov, Lv, Hv, x0, y0, z0)
nudo2, nudo_i2, base_nodes2, elem2, vig2, col12, col22 = modelo('y', 8, nz, 800, esp, alt, ti, parametros_mamposteria,
...
nudo3, nudo_i3, base_nodes3, elem3, vig3, col13, col23 = modelo('y', 12, nz, 1200, esp, alt, ti, parametros_mamposteria,
...
nudo4, nudo_i4, base_nodes4, elem4, vig4, col14, col24 = modelo('y', 12, nz, 1200, esp, alt, ti, parametros_mamposteria,
